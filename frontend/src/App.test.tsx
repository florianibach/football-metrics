...
describe('App', () => {
  ...
  it('R1_6_17_Ac01_Ac02_Ac03_Ac04_Ac05_Ac06_Ac07_Ac08_extends_short_runs_with_blue_context_points_only_for_direction', async () => {
    ...
    expect(screen.getByText(/earlier context points are added in blue for direction only/i)).toBeInTheDocument();
