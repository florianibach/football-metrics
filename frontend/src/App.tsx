...
const metricExplanations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    sprintDistance: 'Purpose: measures high-speed running volume above the sprint threshold. Interpretation: very low values usually mean little sprint exposure, while high values indicate repeated sprint load and stronger mechanical stress. For training context, compare this value with sprint count and high-speed distance to distinguish many short sprints from fewer long fast runs. Unit: km and m. If unavailable, GPS quality was not sufficient.',
    sprintCount: 'Purpose: counts sprint events based on the configured speed threshold. Interpretation: 0-2 is usually low, 3-6 moderate, and >6 high repeated-sprint demand in a typical amateur session. Always read this together with sprint distance: many sprints with low sprint distance often indicate frequent short accelerations, while fewer sprints with high distance indicate longer high-speed phases. Unit: count. If unavailable, GPS quality was not sufficient.',
    maxSpeed: 'Purpose: captures the highest instantaneous running speed reached in the session. Interpretation: <6.0 m/s is rather low, 6.0-7.5 m/s typical, and >7.5 m/s very high for many amateur players. This metric reflects peak capacity, not consistency, so pair it with high-intensity time or high-speed distance to evaluate whether speed was sustained. Unit: m/s. If unavailable, GPS quality was not sufficient.',
    ...
    runningDensity: 'Purpose: normalizes movement volume over time (meters per active minute). Interpretation: higher m/min indicates denser running activity across the full session and usually less passive recovery time. Use it as an overall intensity-density indicator, especially when comparing sessions with different durations. Unit: meters per minute. If unavailable, GPS quality was not sufficient.',
    ...
    hrZoneHigh: 'Purpose: tracks time in the high heart-rate zone (>85%). Interpretation: higher time reflects stronger cardiovascular strain and a more competition-like intensity profile. Persistently high values across many sessions should be balanced with recovery-focused days to avoid overload. Unit: minutes and seconds. If unavailable, heart-rate quality was not sufficient.',
    trimpEdwards: 'Purpose: estimates total internal training load using weighted heart-rate-zone time (Edwards method). Interpretation: rough orientation for amateur sessions is <40 low load, 40-80 moderate, 80-120 high, and >120 very high. Compare TRIMP week-to-week instead of day-to-day only; sudden spikes can indicate an abrupt load increase that should be managed carefully. Unit: score. If unavailable, heart-rate quality was not sufficient.',
  ...
  de: {
    ...
    sprintDistance: 'Zweck: misst das hochintensive Laufvolumen oberhalb der Sprintschwelle. Interpretation: sehr niedrige Werte deuten meist auf wenige Sprintphasen hin, hohe Werte auf ausgeprägte Sprintbelastung und stärkere mechanische Last. Für die Einordnung sollte die Metrik gemeinsam mit Anzahl Sprints und High-Speed-Distanz gelesen werden, um kurze wiederholte Sprints von längeren schnellen Läufen zu unterscheiden. Einheit: km und m. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    sprintCount: 'Zweck: zählt Sprintaktionen anhand der konfigurierten Geschwindigkeitsschwelle. Interpretation: 0-2 ist meist niedrig, 3-6 mittel und >6 hoch für eine typische Amateur-Session. In Kombination mit Sprintdistanz zeigt die Metrik, ob eher viele kurze Sprints oder wenige längere schnelle Aktionen durchgeführt wurden. Einheit: Anzahl. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    maxSpeed: 'Zweck: erfasst die höchste momentane Laufgeschwindigkeit der Session. Interpretation: <6,0 m/s eher niedrig, 6,0-7,5 m/s typisch und >7,5 m/s für viele Amateurspieler sehr hoch. Die Metrik zeigt das Tempo-Potenzial, nicht die Dauerleistung, daher zusammen mit High-Intensity-Time oder High-Speed-Distanz bewerten. Einheit: m/s. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    ...
    runningDensity: 'Zweck: normiert das Bewegungsvolumen über die Zeit (Meter pro aktive Minute). Interpretation: höhere m/min bedeuten insgesamt dichtere Laufaktivität und meist weniger passive Erholungsphasen. Besonders hilfreich ist die Kennzahl beim Vergleich von Sessions mit unterschiedlicher Dauer. Einheit: Meter pro Minute. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    ...
    hrZoneHigh: 'Zweck: misst die Zeit in hoher Herzfrequenzintensität (>85%). Interpretation: mehr Zeit steht für stärkeren kardiovaskulären Stress und ein wettkampfnahes Intensitätsprofil. Bleibt dieser Anteil über viele Sessions hoch, sollte bewusst mit Regenerationstagen gegengesteuert werden, um Überlastung zu vermeiden. Einheit: Minuten und Sekunden. Falls nicht verfügbar, war die HF-Qualität zu gering.',
    trimpEdwards: 'Zweck: schätzt die gesamte interne Trainingslast über gewichtete Herzfrequenz-Zonenzeiten (Edwards-Methode). Interpretation: grobe Orientierung für Amateur-Sessions: <40 niedrig, 40-80 mittel, 80-120 hoch, >120 sehr hoch. Sinnvoll ist vor allem der Wochenvergleich: deutliche TRIMP-Sprünge können auf eine abrupte Laststeigerung hinweisen und sollten aktiv gesteuert werden. Einheit: Score. Falls nicht verfügbar, war die HF-Qualität zu gering.',
