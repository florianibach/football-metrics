...
const translations: Record<Locale, Record<TranslationKey, string>> = {
  en: {
    ...
    gpsRunsMapExplanation: 'Sprint points are red within HSR runs, HSR-only points stay orange. If a run has fewer than 4 threshold points, earlier context points are added in blue for direction only. Point size increases in running direction; outlined points mark run endings.',
  ...
  de: {
    ...
    gpsRunsListTopSpeed: 'Top-Speed',
    gpsRunsMapExplanation: 'Sprint-Punkte innerhalb von HSR-Runs sind rot, reine HSR-Punkte bleiben orange. Falls ein Run weniger als 4 Schwellen-Punkte hat, werden davorliegende Kontextpunkte nur zur Richtung in Blau ergänzt. Die Punktgröße steigt mit der Laufrichtung; umrandete Punkte markieren das Run-Ende.',
