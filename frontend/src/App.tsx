...
const metricExplanations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    sprintDistance: 'Purpose: measures high-speed running volume. Interpretation: very low values usually mean little sprint exposure, high values indicate repeated sprint load. Unit: km and m. If unavailable, GPS quality was not sufficient.',
    sprintCount: 'Purpose: counts sprint events. Interpretation: 0-2 is low, 3-6 is moderate, >6 is high repeated-sprint demand in a typical amateur session. Unit: count. If unavailable, GPS quality was not sufficient.',
    maxSpeed: 'Purpose: captures peak running speed. Interpretation: <6.0 m/s is rather low, 6.0-7.5 m/s typical, >7.5 m/s very high for many amateur players. Unit: m/s. If unavailable, GPS quality was not sufficient.',
    highIntensityTime: 'Purpose: tracks time at high movement intensity. Interpretation: more time means larger intense workload; combine with sprint metrics for context. Unit: minutes and seconds. If unavailable, GPS quality was not sufficient.',
    highSpeedDistance: 'Purpose: tracks distance above high-speed threshold. Interpretation: higher values suggest sustained fast running capacity, not only short sprints. Unit: km and m. If unavailable, GPS quality was not sufficient.',
    runningDensity: 'Purpose: normalizes movement volume over time. Interpretation: higher m/min indicates denser running activity across the full session. Unit: meters per minute. If unavailable, GPS quality was not sufficient.',
    accelerationCount: 'Purpose: counts explosive speed-ups. Interpretation: more accelerations often mean greater neuromuscular load from repeated bursts. Unit: count. If unavailable, GPS quality was not sufficient.',
    decelerationCount: 'Purpose: counts braking actions. Interpretation: high counts indicate frequent stopping/cutting actions and can increase eccentric muscle stress. Unit: count. If unavailable, GPS quality was not sufficient.',
    hrZoneLow: 'Purpose: tracks low-intensity heart-rate exposure. Interpretation: higher time indicates larger easy-load share within the session. Unit: minutes and seconds. If unavailable, heart-rate quality was not sufficient.',
    hrZoneMedium: 'Purpose: tracks moderate-intensity heart-rate exposure. Interpretation: reflects sustained submaximal work and aerobic conditioning load. Unit: minutes and seconds. If unavailable, heart-rate quality was not sufficient.',
    hrZoneHigh: 'Purpose: tracks high-intensity heart-rate exposure. Interpretation: higher time reflects stronger cardiovascular strain. Unit: minutes and seconds. If unavailable, heart-rate quality was not sufficient.',
    trimpEdwards: 'Purpose: estimates internal load from heart-rate zones. Interpretation: rough orientation for amateur sessions: <40 low load, 40-80 moderate, 80-120 high, >120 very high. Unit: score. If unavailable, heart-rate quality was not sufficient.',
    hrRecovery60: 'Purpose: indicates short-term recovery capacity after effort. Interpretation: rough orientation: <12 bpm drop rather weak, 12-20 moderate, >20 good recovery response. Unit: bpm drop after 60s. If unavailable, heart-rate quality was not sufficient.',
  ...
  de: {
    ...
    sprintDistance: 'Zweck: misst hochintensives Laufvolumen. Interpretation: sehr niedrige Werte deuten meist auf wenige Sprintphasen hin, hohe Werte auf ausgeprägte Sprintbelastung. Einheit: km und m. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    sprintCount: 'Zweck: zählt Sprintaktionen. Interpretation: 0-2 eher niedrig, 3-6 mittel, >6 hoch für eine typische Amateur-Session. Einheit: Anzahl. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    maxSpeed: 'Zweck: erfasst die Spitzengeschwindigkeit. Interpretation: <6,0 m/s eher niedrig, 6,0-7,5 m/s typisch, >7,5 m/s sehr hoch für viele Amateurspieler. Einheit: m/s. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    highIntensityTime: 'Zweck: misst Zeit in hoher Bewegungsintensität. Interpretation: mehr Zeit bedeutet höhere intensive Arbeitslast; zusammen mit Sprintwerten betrachten. Einheit: Minuten und Sekunden. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    highSpeedDistance: 'Zweck: misst Distanz oberhalb der High-Speed-Schwelle. Interpretation: höhere Werte sprechen für mehr anhaltend schnelles Laufen, nicht nur kurze Sprints. Einheit: km und m. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    runningDensity: 'Zweck: normiert Bewegungsvolumen über die Zeit. Interpretation: höhere m/min bedeuten insgesamt dichtere Laufaktivität. Einheit: Meter pro Minute. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    accelerationCount: 'Zweck: zählt explosive Beschleunigungen. Interpretation: hohe Werte bedeuten viele Antritte und meist höhere neuromuskuläre Belastung. Einheit: Anzahl. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    decelerationCount: 'Zweck: zählt Bremsaktionen. Interpretation: hohe Werte bedeuten viele Stopp-/Abbremsbewegungen und können die muskuläre Last erhöhen. Einheit: Anzahl. Falls nicht verfügbar, war die GPS-Qualität zu gering.',
    hrZoneLow: 'Zweck: misst HF-Exposition in niedriger Intensität. Interpretation: mehr Zeit bedeutet höheren Anteil lockerer Belastung in der Einheit. Einheit: Minuten und Sekunden. Falls nicht verfügbar, war die HF-Qualität zu gering.',
    hrZoneMedium: 'Zweck: misst HF-Exposition in mittlerer Intensität. Interpretation: zeigt den Anteil dauerhafter submaximaler Arbeit und aerober Belastung. Einheit: Minuten und Sekunden. Falls nicht verfügbar, war die HF-Qualität zu gering.',
    hrZoneHigh: 'Zweck: misst HF-Exposition in hoher Intensität. Interpretation: mehr Zeit steht für stärkeren kardiovaskulären Stress. Einheit: Minuten und Sekunden. Falls nicht verfügbar, war die HF-Qualität zu gering.',
    trimpEdwards: 'Zweck: schätzt die interne Belastung über HF-Zonen. Interpretation: grobe Orientierung für Amateur-Sessions: <40 niedrig, 40-80 mittel, 80-120 hoch, >120 sehr hoch. Einheit: Score. Falls nicht verfügbar, war die HF-Qualität zu gering.',
    hrRecovery60: 'Zweck: zeigt kurzfristige Erholungsfähigkeit nach Belastung. Interpretation: grobe Orientierung: <12 bpm Abfall eher schwach, 12-20 mittel, >20 gut. Einheit: bpm-Abfall nach 60 s. Falls nicht verfügbar, war die HF-Qualität zu gering.',
