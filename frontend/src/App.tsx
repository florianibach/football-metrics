      ...
      {selectedSession && (
        <section className="session-details" aria-live="polite">
          ...
          <div className="core-metrics-section">
            ...
            <ul className="metrics-list">
              <li><strong>{t.metricDistance}:</strong> {formatDistanceComparison(selectedSession.summary.coreMetrics.distanceMeters, locale, t.notAvailable)} ({formatMetricStatus('distanceMeters', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricSprintDistance}:</strong> {formatDistanceComparison(selectedSession.summary.coreMetrics.sprintDistanceMeters, locale, t.notAvailable)} ({formatMetricStatus('sprintDistanceMeters', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricSprintCount}:</strong> {selectedSession.summary.coreMetrics.sprintCount ?? t.notAvailable} ({formatMetricStatus('sprintCount', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricMaxSpeed}:</strong> {formatSpeedMetersPerSecond(selectedSession.summary.coreMetrics.maxSpeedMetersPerSecond, t.notAvailable)} ({formatMetricStatus('maxSpeedMetersPerSecond', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHighIntensityTime}:</strong> {formatDuration(selectedSession.summary.coreMetrics.highIntensityTimeSeconds, locale, t.notAvailable)} ({formatMetricStatus('highIntensityTimeSeconds', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHighSpeedDistance}:</strong> {formatDistanceComparison(selectedSession.summary.coreMetrics.highSpeedDistanceMeters, locale, t.notAvailable)} ({formatMetricStatus('highSpeedDistanceMeters', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricRunningDensity}:</strong> {formatNumber(selectedSession.summary.coreMetrics.runningDensityMetersPerMinute, locale, t.notAvailable, 2)} ({formatMetricStatus('runningDensityMetersPerMinute', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricAccelerationCount}:</strong> {selectedSession.summary.coreMetrics.accelerationCount ?? t.notAvailable} ({formatMetricStatus('accelerationCount', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricDecelerationCount}:</strong> {selectedSession.summary.coreMetrics.decelerationCount ?? t.notAvailable} ({formatMetricStatus('decelerationCount', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHrZoneLow}:</strong> {formatDuration(selectedSession.summary.coreMetrics.heartRateZoneLowSeconds, locale, t.notAvailable)} ({formatMetricStatus('heartRateZoneLowSeconds', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHrZoneMedium}:</strong> {formatDuration(selectedSession.summary.coreMetrics.heartRateZoneMediumSeconds, locale, t.notAvailable)} ({formatMetricStatus('heartRateZoneMediumSeconds', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHrZoneHigh}:</strong> {formatDuration(selectedSession.summary.coreMetrics.heartRateZoneHighSeconds, locale, t.notAvailable)} ({formatMetricStatus('heartRateZoneHighSeconds', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricTrimpEdwards}:</strong> {formatNumber(selectedSession.summary.coreMetrics.trainingImpulseEdwards, locale, t.notAvailable, 1)} ({formatMetricStatus('trainingImpulseEdwards', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
              <li><strong>{t.metricHrRecovery60}:</strong> {selectedSession.summary.coreMetrics.heartRateRecoveryAfter60Seconds ?? t.notAvailable} ({formatMetricStatus('heartRateRecoveryAfter60Seconds', selectedSession.summary.coreMetrics, t) ?? 'Available'})</li>
