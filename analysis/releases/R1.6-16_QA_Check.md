...
- `Sprint distance` (Core Metric) wird auf Basis der **erkannten Sprint-Phasen** berechnet.
- Einzelne Samples oberhalb der Sprint-Schwelle ohne vollständige Run-Detektion (Consecutive-Logik) werden **nicht** als Sprint-Phase gezählt.
- Dadurch entspricht `Sprint distance` der Summe der verschachtelten Sprint-Phasen (`of which sprint phase distance`).
