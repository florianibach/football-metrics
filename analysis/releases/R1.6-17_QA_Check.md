...
1. **Mindestens vier GPS-Punkte pro HSR-/Sprint-Run auf der Map**
   ...
   - Abgedeckt durch Frontend-Test `R1_6_17_Ac01_Ac02_Ac03_Ac04_Ac05_Ac06_Ac07_Ac08_extends_short_runs_with_blue_context_points_only_for_direction`.
...
3. **Visuelle Kennzeichnung ergänzter Punkte**
   - Ergänzte Punkte erhalten eigene Klasse `.gps-heatmap__run--supplemental` (blau), Schwellenpunkte behalten HSR/Sprint-Farbe.
